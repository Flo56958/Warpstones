...
public class NBTUtilitiesReflections implements NBTTag {
	...
	public static Object getNBTTagCompound(ItemStack itemstack) {
		try {
			Class<?> craftItemStack = Class.forName("org.bukkit.craftbukkit." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".inventory.CraftItemStack");
	...
	public static void setNBTTagCompound(ItemStack itemstack, Object nbtTagCompound) {
		try {
			Class<?> nbtTagCompoundClass = Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagCompound");
	...
	public static Object parse(String s) {
		try {
			Class<?> mojangparser = Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".MojangsonParser");
	...
	public static Object createNBTTagCompound() {
		try {
			Class<?> nbt = Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagCompound");
	...
	public static List<?> createNBTTagList() {
		try {
			Class<?> nbt = Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagList");
	...
	public static Object createNBTBase(Object value) {
		try {
			if (value instanceof Byte)
				return SimpleReflection.createObject(Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagByte"), value);
			else if (value instanceof byte[])
				return SimpleReflection.createObject(Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagByteArray"), value);
			else if (value instanceof Double)
				return SimpleReflection.createObject(Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagDouble"), value);
			else if (value instanceof Float)
				return SimpleReflection.createObject(Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagFloat"), value);
			else if (value instanceof Integer)
				return SimpleReflection.createObject(Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagInt"), value);
			else if (value instanceof int[])
				return SimpleReflection.createObject(Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagIntArray"), value);
			else if (value instanceof Long)
				return SimpleReflection.createObject(Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagLong"), value);
			else if (value instanceof long[])
				return SimpleReflection.createObject(Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagLongArray"), value);
			else if (value instanceof Short)
				return SimpleReflection.createObject(Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagShort"), value);
			else if (value instanceof String)
				return SimpleReflection.createObject(Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagString"), value);
	...
	public static Object getValue(Object nbtbase) {
		...
		try {
			if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagByte").isAssignableFrom(nbtBaseClass))
				return SimpleReflection.callMethod(nbtbase, "asByte");
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagCompound").isAssignableFrom(nbtBaseClass))
				return new NBTUtilitiesReflections(nbtbase);
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagList").isAssignableFrom(nbtBaseClass))
				return (List<?>) nbtbase;
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagByteArray").isAssignableFrom(nbtBaseClass))
				return SimpleReflection.callMethod(nbtbase, "getBytes");
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagDouble").isAssignableFrom(nbtBaseClass))
				return SimpleReflection.callMethod(nbtbase, "asDouble");
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagFloat").isAssignableFrom(nbtBaseClass))
				return SimpleReflection.callMethod(nbtbase, "asFloat");
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagInt").isAssignableFrom(nbtBaseClass))
				return SimpleReflection.callMethod(nbtbase, "asInt");
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagIntArray").isAssignableFrom(nbtBaseClass))
				return SimpleReflection.callMethod(nbtbase, "getInts");
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagLong").isAssignableFrom(nbtBaseClass))
				return SimpleReflection.callMethod(nbtbase, "asLong");
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagLongArray").isAssignableFrom(nbtBaseClass))
				return SimpleReflection.callMethod(nbtbase, "getLongs");
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagShort").isAssignableFrom(nbtBaseClass))
				return SimpleReflection.callMethod(nbtbase, "asShort");
			else if (Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagString").isAssignableFrom(nbtBaseClass))
	...
	public NBTUtilitiesReflections(Object nbtTagCompound) {
		try {
			Class<?> nbtBase = Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTTagCompound");
	...
	public void set(String key, Object value) {
		try {
			Class<?> nbtBase = Class.forName("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3] + ".NBTBase");
