...
public class LanguageManager {
	...
	public static void reload() {
		String lang = Main.plugin.getConfig().getString("Language", "en_US");
		...
		playerLocale = Main.plugin.getConfig().getBoolean("EnablePlayerLocale", false);
	...
	public static String getString(@NotNull String path, @Nullable Player player) {
		...
		if (playerLocale && !player.getLocale().equals(Main.plugin.getConfig().getString("Language"))) {
	...
	private static YamlConfiguration loadLanguage(@NotNull String lang) {
		...
		File file = new File(Main.plugin.getDataFolder(), "lang" + File.separator + lang + ".yml");
		try {
